...
class MorePage extends StatelessWidget {
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildSectionContainer(context, [
            _MenuItemData(Icons.category_outlined, 'Categorias', const Color(0xFFE91E63), () => context.push('/categories')),
            _MenuItemData(Icons.notifications_outlined, 'Notificações', const Color(0xFFFF5722), () => context.push('/notifications')),
            _MenuItemData(Icons.bar_chart, 'Relatórios', const Color(0xFF607D8B), () => context.push('/reports')),
          ]),
          ...
          const SizedBox(height: 12),
          _buildSectionContainer(context, [
            _MenuItemData(Icons.person_outline, 'Perfil', theme.colorScheme.primary, () => context.push('/profile')),
            _MenuItemData(Icons.settings_outlined, 'Configurações', const Color(0xFF78909C), () => context.push('/settings')),
          ]),
  ...
  Widget _buildSectionContainer(BuildContext context, List<_MenuItemData> items) {
    final theme = Theme.of(context);
    return Padding(
