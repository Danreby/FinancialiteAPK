...
abstract class TransactionRepository {
  Future<List<Transaction>> getTransactions({Map<String, dynamic>? filters, int page = 1, int perPage = 20});
  ...
  Future<List<Map<String, dynamic>>> getTopSpending({Map<String, dynamic>? filters});
