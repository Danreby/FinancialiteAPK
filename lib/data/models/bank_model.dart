...
class BankAccountModel extends BankAccount {
  ...
  factory BankAccountModel.fromJson(Map<String, dynamic> json) {
    return BankAccountModel(
      ...
      bankName: json['bank']?['name'] as String? ?? json['bank_name'] as String?,
      bankCode: json['bank']?['code'] as String? ?? json['bank_code'] as String?,
      bankColor: json['bank']?['color'] as String? ?? json['bank_color'] as String?,
      bankLogo: json['bank']?['logo'] as String? ?? json['bank_logo'] as String?,
...
class BankModel extends Bank {
  const BankModel({required super.id, required super.name, super.code, super.color, super.logo});
...
class BankStatsModel extends BankStats {
  const BankStatsModel({required super.totalBalance, required super.totalIncome, required super.accountCount});
