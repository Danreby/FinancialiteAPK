...
class TransactionModel extends Transaction {
  ...
  factory TransactionModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['parcelas'] != null) {
      parcelas = (json['parcelas'] as List).map((p) => TransactionParcelaModel.fromJson(p)).toList();
    }
    ...
    return TransactionModel(
      ...
      categoryName: json['category']?['name'] as String? ?? json['category_name'] as String?,
      categoryIcon: json['category']?['icon'] as String? ?? json['category_icon'] as String?,
      categoryColor: json['category']?['color'] as String? ?? json['category_color'] as String?,
      cardName: json['card_user']?['card']?['name'] as String? ?? json['card_name'] as String?,
      bankName: json['bank_user']?['bank']?['name'] as String? ?? json['bank_name'] as String?,
      parcelas: parcelas,
...
class TransactionParcelaModel extends TransactionParcela {
  ...
  factory TransactionParcelaModel.fromJson(Map<String, dynamic> json) {
    return TransactionParcelaModel(
      id: json['id'] as int?,
      transactionId: json['transaction_id'] as int? ?? json['transacao_id'] as int? ?? 0,
      parcelaNumber: json['parcela_number'] as int? ?? json['numero'] as int? ?? 1,
